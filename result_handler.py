...
class ResultHandler:
    ...
    def __init__(self, database_name: str):
        ...
        self.generator_log: List[Tuple[str, str, str]] = []  # (generator_name, table_name, column_name)
    ...
    def log_generator_usage(self, generator_name: str, table_name: str, column_name: str) -> None:
